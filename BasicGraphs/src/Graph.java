...
public class Graph {
    ...
    public static void main(String[] args) {
        // In in = new In(args[0]);
        // In teste = new In(new File("/.casos2/c2a.txt"));
        // Graph G = new Graph(teste);
        // CaminhamentoLargura teste2 = new CaminhamentoLargura(G, 0);
        // System.out.println(teste2.distTo("z"));
        // StdOut.println(G);
        // StdOut.println();
